"""Volatility-adjusted 1% ATR position sizer for crypto assets."""
...
class PositionSizer:
    ...
    def __init__(
        ...
        max_capital_per_trade_pct: float = 33.33,
    ):
    ...
    def calculate_size(
        ...
        # Cap at max allocation per position
        max_capital_allowed = equity * (self.max_capital_per_trade_pct / 100.0)
